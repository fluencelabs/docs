...
> You will need Testnet payment and gas tokens to try Fluence. Consider reading [Wallet management & Token Faucets Guide](get-started/wallet-management) for step-by-step instructions on how to get them.

> Fluence also has it's own internal peer key management processes, consider reading: [Keys management with Fluence CLI](cli-keys-management.md)
