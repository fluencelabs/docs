...
This guide walks you through deploying a GPU instance on Fluence. GPU Cloud supports three workload types — containers, VMs, and bare metal — each covered below. For background on workload types, instance lifecycle, and how billing works, see the [GPU Cloud concepts](./overview.md).

When you deploy, the system reserves 3 hours of rent from your account balance — one hour is charged immediately, the other two are kept as a reserve. Make sure your balance has enough funds before starting. See [billing model](./overview.md#billing-model) for details.
...
![Select GPU model](./assets/instance_rent/containers/gpu_models.webp)
...
![Select configuration](./assets/instance_rent/containers/configurations.webp)
...
![Specify instance name](./assets/instance_rent/containers/set_name.webp)
...
![Set container image](./assets/instance_rent/containers/set_image.webp)
...
![Custom image dialog](./assets/instance_rent/containers/set_custom_image.webp)
...
![Container start command](./assets/instance_rent/containers/start_command.webp)
...
![Configure ports](./assets/instance_rent/containers/ports.webp)
...
![Environment variables](./assets/instance_rent/containers/env.webp)
...
![Select SSH keys](./assets/instance_rent/containers/ssh_keys.webp)
...
![Select GPU model](./assets/instance_rent/vm_baremetal/gpu_models.webp)
...
![Select GPU count](./assets/instance_rent/vm_baremetal/gpu_count.webp)
...
![Select configuration](./assets/instance_rent/vm_baremetal/configurations.webp)

### Specify the instance name

In the **Configure deployment** section, provide a name for your instance in the **Basic Information** field. A random name is generated by default, but you can customize it.

![Specify instance name](./assets/instance_rent/vm_baremetal/set_name.webp)
...
![Set OS image](./assets/instance_rent/vm_baremetal/set_image.webp)
...
:::info
You need at least one SSH key registered to access your instance. SSH keys can be managed in [Settings](../settings.md).
:::

![Select SSH keys](./assets/instance_rent/vm_baremetal/ssh_keys.webp)
